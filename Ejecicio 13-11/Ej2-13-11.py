...
Tu tarea es diseñar un conjunto de clases orientadas a objetos para manejar productos, carritos de compra, usuarios y pedidos.
...
Utiliza la composición para gestionar la relación entre productos y carritos, 
y asegúrate de que el diseño sea escalable para futuras características del comercio electrónico."""
